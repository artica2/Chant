...
public class MicrophoneInput : MonoBehaviour {
	...
	public void ResetMicrophoneClip() {
	...
	/// 
	/// </summary>
	/// <returns>Current clip for audio source attached to microphone input's gameobject</returns>
	public string ExportCurrentClipToWAV(string a_fileName) {
		if (audioSource.clip == null) {
			Debug.LogError("No audio clip found (The Microphone was not recording for some reason!!!).");
			return string.Empty;
		}

		return RARE.Instance.ExportClip(a_fileName, audioSource.clip);
	}
